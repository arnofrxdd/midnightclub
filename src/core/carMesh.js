...
function getCachedGeometries(type) {
  ...
  if (type === 'sports' || type === 'cop') {
    ...
    if (type === 'sports') {
      const eL = new THREE.CylinderGeometry(0.08, 0.08, 0.4, 8);
      eL.rotateX(Math.PI / 2);
      eL.translate(-0.48, 0.18, backZ - 0.15);

      const eR = new THREE.CylinderGeometry(0.08, 0.08, 0.4, 8);
      eR.rotateX(Math.PI / 2);
      eR.translate(0.48, 0.18, backZ - 0.15);
